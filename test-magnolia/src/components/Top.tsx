...
const Top = () => {
    const {setType,setCurrentpage} = useContext(Pokecontext)

    return (
        <div className={styles.Top}>
            <button onClick={()=>{setType(''),setCurrentpage(1)}} className={styles.TopAcceuil}>
            ...
            <div className={styles.TopWrapper}>
                <div className={styles.TopTypeWrapper}>
